...
public class ReceiptDAO {
    ...
    public ArrayList<Receipt> selectAll(){
        ...
        if (cursor.moveToFirst()){
            while (!cursor.isAfterLast()){
                ...
                objR.setName(cursor.getString(3));
                objR.setBien_ks(cursor.getString(4));
                objR.setOder_time(cursor.getString(5));
                objR.setStart_time(cursor.getString(6));
                objR.setEnd_time(cursor.getString(7));
                objR.setStatus_driver(cursor.getInt(8));
                objR.setStatus(cursor.getInt(9));
                objR.setTotal(cursor.getInt(10));
                objR.setDia_diem(cursor.getString(11));
                objR.setClient_id(cursor.getInt(12));
                objR.setVehicles_id(cursor.getInt(13));
                    list.add(objR);
                    cursor.moveToNext();
            }
    ...
    public  boolean insert(Receipt objR){
        ...
        values.put(Receipt.COL_name, objR.getName());
        values.put(Receipt.COL_bien_ks, objR.getBien_ks());
